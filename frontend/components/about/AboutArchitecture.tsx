...
import AboutPrinciplesStrip from "./AboutPrinciplesStrip";
import AboutStats from "./AboutStats";
import ArchitectureDiagram from "./ArchitectureDiagram";
import { DetailPanel, SectionHead, SelectableCard } from "./AboutShared";
import JourneyFlow from "./JourneyFlow";
import MlopsCycleDiagram from "./MlopsCycleDiagram";
import ProductVideoPlate from "./ProductVideoPlate";
import RankingFunnelDiagram from "./RankingFunnelDiagram";
import { INK, PRINCIPLES, type DetailKey } from "./details";
    ...
    <div className="about-root" data-testid="about-funnel">
      ...
      <motion.section className="panel" {...fadeUp} data-testid="about-deploy">
        <SectionHead
          ...
          lede="Vercel hosts the UI; Fly hosts FastAPI with SQLite on a persistent volume. Operator runbook: docs/DEPLOYMENT.md."
          icon={Server}
        />
        <button
          type="button"
      ...
      <footer className="panel about-footer-note" data-testid="about-footer">
        <p className="about-colophon">
          ...
          <code className="font-num">docs/ARCHITECTURE.md</code> and{" "}
          <code className="font-num">docs/DEPLOYMENT.md</code> in the repo. Built with FastAPI · Next.js ·
