...
/** Accent for diagram defaults; brass is reserved for active/flow highlight via CSS. */
export const BRASS = "var(--accent)";
...
export const FUNNEL_STEPS: {
  ...
  { key: "retrieve", title: "Retrieve", short: "150+ multi-source", hue: "var(--accent)" },
  { key: "dense", title: "Dense + BM25", short: "Two rankings", hue: "var(--accent)" },
  { key: "rrf", title: "RRF fuse", short: "k = 60", hue: "var(--accent)" },
  { key: "cross_encoder", title: "Cross-enc", short: "RRF50→CE→15", hue: "var(--accent)" },
  { key: "llm_rerank", title: "LLM rerank", short: "Listwise-ready", hue: "var(--accent)" },
  { key: "fuse", title: "Final score", short: "Weighted fuse", hue: "var(--accent)" },
  { key: "mmr", title: "MMR top 10", short: "λ = 0.75", hue: "var(--warning)" },
];

export const SCORE_BARS = [
  { id: "score_llm" as const, weight: SCORE_WEIGHTS.llm, label: "llm_fit", c: "var(--accent)" },
  { id: "score_rrf" as const, weight: SCORE_WEIGHTS.rrf, label: "rrf", c: "var(--accent)" },
  { id: "score_skills" as const, weight: SCORE_WEIGHTS.skills, label: "skills", c: "var(--accent)" },
  { id: "score_experience" as const, weight: SCORE_WEIGHTS.experience, label: "experience", c: "var(--accent)" },
  { id: "score_requirements" as const, weight: SCORE_WEIGHTS.requirements, label: "requirements", c: "var(--warning)" },
  { id: "score_recency" as const, weight: SCORE_WEIGHTS.recency, label: "recency", c: "var(--accent)" },
] as const;
