...
class Settings(BaseSettings):
    ...
    JOBS_SOURCE_ARBEITNOW_ENABLED: bool = True
    JOBS_SOURCE_JOBICY_ENABLED: bool = True
    JOBS_SOURCE_HIMALAYAS_ENABLED: bool = True
    ...
    RRF_K: int = 60
    JOBS_FETCH_TARGET: int = 300
    JOBS_RECENCY_DAYS: int = 14
    JSEARCH_MAX_REQUESTS_PER_SEARCH: int = 6
    LOCATION_MISMATCH_PENALTY: float = 18.0
    RERANK_TOP_N: int = 60
    SEARCH_RESULTS_TOP_N: int = 30
    ...
    CROSS_ENCODER_POOL: int = 80
    LLM_RERANK_TOP_N: int = 25
    ...
    @field_validator(
        ...
        "JOBS_SOURCE_ARBEITNOW_ENABLED",
        "JOBS_SOURCE_JOBICY_ENABLED",
        "JOBS_SOURCE_HIMALAYAS_ENABLED",
