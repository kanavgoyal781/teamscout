...
def parse_salary_min(
    *,
    ...
    """Return (salary_min_annual_estimate, salary_unknown)."""
...
def annotate_job(
    ...
    *,
    ...
    """Return a copy of job with seniority / remote / employment / salary filled."""
...
def apply_hard_filters(
    ...
    *,
    ...
    """Exclude jobs failing hard preferences; never drop salary-unknown on min_salary."""
