...
def render_ops_html(stats: dict[str, Any]) -> str:
    lat_rows = [
    ...
    summary_rows: list[list[Any]] = [[k, stats.get(k)] for k in (
        "total_cost_today_usd","llm_cost_today_usd","llm_ceiling_usd","sumble_credits_today","sumble_ceiling",
        "cost_per_feature1_run_usd","feature1_runs_today","cost_per_feature2_run_usd","feature2_runs_today",
        "embedding_cache_hit_rate","embedding_cache_hits","embedding_cache_total",
        "jsearch_requests_last_search","jsearch_requests_today","jsearch_searches_today")] + [["m24_panel", stats.get("m24_panel") or ""]]
