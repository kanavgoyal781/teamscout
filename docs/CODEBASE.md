...
> **Doc drift:** `AGENTS.md` is still M3-framed; `docs/SPEC.md` / `README.md` describe M4 product scope and do not cover M5/M6 Sumble changes. Prefer **this file** for architecture truth.
...
From `AGENTS.md`, `docs/SPEC.md`, and `backend/app/errors.py` — verified against code:
...
| `docs/SPEC.md` | Milestone 4 product | Accurate for Feature 2 + retained M3; does not document M5/M6 Sumble API/credit details. |
...
*This document reflects the codebase as of 2026-07-08 (post M5/M6 Sumble commits). For demo steps see `README.md`; for M4 acceptance criteria see `docs/SPEC.md`; for contributor honesty rules see `AGENTS.md`.*
